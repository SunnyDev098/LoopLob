...
public class firebase_start_scr : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        // ✅ STEP 1: Wait for notification permission BEFORE Firebase init
        ...
        // ✅ STEP 3: Scene setup after Firebase is ready
        if (PlayerPrefs.HasKey("username"))
        {
            if (start_scene_go != null) start_scene_go.SetActive(true);
            if (auth_scene_go != null) auth_scene_go.SetActive(false);
        }
    }
